...
<section class="uk-section uk-text-center uk-flex uk-flex-middle uk-flex-center uk-light uk-background-cover uk-background-top-center"
    ...
    <div class="tw-page-title-container tw-element">
        <h1 class="tw-page-title uk-text-uppercase">Online poradna</h1>
    </div>
</section>
...
<section class="uk-section">
    ...
    <style>
    .header{background:#e5007d !important;}
    </style>

        <div id="esthtcn-20731-wdgt" style="font-family: 'Champagne-Limousines'; margin-top: 20px; margin-bottom: 1em; width:100%; background-color: rgb(255, 255, 255);">
  <div data-id="powered-by" style="text-align:right;margin-top:-18px;line-height:18px;font-size:10px;color:black;"></div>
  <script type="text/javascript">
    var _esthtcn = _esthtcn || [];
    var _widget = [];
    _widget.push(['setContent', 'questions_and_answers']);
    _widget.push(['setWid', '20731']);
    _widget.push(['setAccount', '17438']);
    _widget.push(['setPortalVersion', '1']);
    _widget.push(['setVersion', '2']);
    _widget.push(['setAbranch', '1']);
    _widget.push(['setType', 'large']);
    _widget.push(['setCount', '5']);    
    _widget.push(['setSkin', 'light']);
    _esthtcn.push(_widget);
    (function() {
      var esthtcn = document.createElement('script'); esthtcn.type = 'text/javascript'; esthtcn.id='esthtcn-20731-scrpt'; esthtcn.async = true;
