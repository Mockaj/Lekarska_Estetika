...
<title>LékařskáEstetika.cz - Vybavení</title>
...
<section class="uk-section uk-text-center uk-flex uk-flex-middle uk-flex-center uk-light uk-background-cover uk-background-top-center"
    ...
    <div class="tw-page-title-container tw-element">
        <h1 class="tw-page-title uk-text-uppercase">Poskytované zákroky</h1>
    </div>
</section>
...
<section class="uk-section">
    <div class="uk-container">
        ...
        <div class="tw-element uk-child-width-1-2@s uk-child-width-1-4@m" data-uk-grid data-uk-scrollspy="target: > div; cls:uk-animation-slide-top-medium; delay: 300;">
          ...
          <?php
                            foreach ($database->clanky->where("kategorie_clanky_id",2)->order("poradi ASC") as $zaznam) {
                                ?>  
            ...
            <div>
                <div class="tw-element tw-box">
                    ...
                    <p class="description">
                       <?= $zaznam['text_short'] ?>
                       <?//= substr($zaznam['text_short'], 0, 85) ?>
                    </p>
                    <a href="sluzby/<?= $zaznam['url'] ?>/" class="uk-button uk-button-default uk-button-small uk-button-radius dark-hover tw-hover"><span class="tw-hover-inner"><span>Více informací</span><i class="ion-ios-arrow-thin-right"></i></span></a>
                </div>
            </div>
